...
export function TopBar({ email, data }: { email: string; data: DataState }) {
  ...
  return (
    <header className="topbar">
      ...
      <div className="topbar__budget">
        ...
        <span className="ph-mono" style={{ fontSize: "var(--ph-text-xs)" }}>{formatEuro(totals.target)}</span>
      </div>
      ...
      <Button variant="ghost" size="sm" onClick={addPasskey}>Add passkey</Button>
